...
const APP_VERSION   = 'stac-engage-v1.8.0';
...
self.addEventListener('fetch', event => {
  ...
  // Supabase API and CDN — never cache, always network
  ...
  // jsdelivr CDN (Supabase JS + Tabler icons) — network first, safe clone
  if (url.hostname.includes('jsdelivr') || url.hostname.includes('cdn.jsdelivr')) {
    event.respondWith(
